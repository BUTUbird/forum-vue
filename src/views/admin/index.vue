<template>
  <el-container style="height: 750px; border: 2px solid #ffffff; width: 100%">
...
<!--            <router-link :to="{path:'/admin/card/echar'}"><el-menu-item >热门标签文章数及比例</el-menu-item></router-link>-->
<!--          </el-submenu>-->
          <el-submenu index="2">
